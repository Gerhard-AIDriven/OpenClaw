...
console.log('\n📊 SPAR Sigma - Groceries4y Department - Bad Performers Analysis (Scenario 2)\n');

const inputFile = 'Spar/Data Extracts/gws groceries4y.xls';
const outputJsonFile = 'Spar/Data Extracts/groceries4y_cull_candidates.json';
const outputHtmlFile = 'Spar/Data Extracts/groceries4y_cull_candidates_report.html';

console.log(`Input File: ${inputFile}`);
console.log(`Analysis Period: 1 March 2022 - 1 April 2026 (38 months detected)\n`);
...
<head>
    ...
    <title>SPAR Groceries4y - Cull Candidates Analysis</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🗑️ Groceries4y Department - Bad Performers (Cull Candidates)</h1>
        ...
        <div class="section">
            ...
            <div class="alert">
                <strong>⚠️ Finding:</strong> ${badProducts.length} groceries4y products show declining trends in sales volume and/or profitability. These are candidates for culling, consolidation, or close monitoring.
            </div>
        </div>
        ...
        <div class="footer">
            <p>Report Generated: 19 April 2026 | SPAR Groceries4y Department | Bad Performers Analysis (Scenario 2)</p>
        </div>
    </div>
</body>
</html>`;
