...
console.log("=== LUNCH (2026-04-20 - NO MAYO) ===\n");
items.forEach(item => {
...
console.log(`\n✅ MUCH BETTER`);
console.log(`Fat: 20.1g/49g (41%) — leaves 28.9g buffer for dinner`);
console.log(`Carbs: 73.6g/219g (34%) — need 145.4g more at dinner`);
console.log(`Calories: 420/1750 (24%) — leaves 1330 cal for dinner`);
