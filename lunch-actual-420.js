const items = [
  ...
  { name: "Dijon mustard (1 tsp)", cal: 3, carbs: 0.1, protein: 0.1, fat: 0.2 },
...
console.log("=== LUNCH ACTUAL (2026-04-20) ===\n");
items.forEach(item => {
...
// Breakfast actual: 157g double fat yogurt, 8g Alpen muesli, 1 banana, 1 ts honey, 25ml low fat milk
// Let me recalculate from earlier data
...
console.log(`\n=== CUMULATIVE (Breakfast + Lunch Actual) ===`);
...
console.log(`\n✅ PERFECT LUNCH`);
console.log(`Smart swap: Dijon mustard (0.2g fat) instead of mayo (20g fat)`);
console.log(`Total: 423 cal | 54.1g carbs | 22.4g protein | 14.5g fat`);
