...
console.log('\n📊 SPAR Sigma - Groceries Department - Good Performers Analysis (Scenario 1)\n');

const inputFile = 'Spar/Data Extracts/gws groceries.xls';
const outputJsonFile = 'Spar/Data Extracts/groceries_uptrend_analysis.json';
const outputHtmlFile = 'Spar/Data Extracts/groceries_uptrend_analysis_report.html';
...
<head>
    ...
    <title>SPAR Groceries - Uptrend Analysis</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>📈 Groceries Department - Good Performers (Uptrend Analysis)</h1>
        ...
        <div class="section">
            ...
            <div class="alert">
                <strong>✓ Finding:</strong> ${goodProducts.length} groceries products show uptrend in both sales volume AND profitability. These are expansion candidates for promotion and increased shelf space.
            </div>
        </div>
        ...
        <div class="footer">
            <p>Report Generated: 19 April 2026 | SPAR Groceries Department | Good Performers Analysis (Scenario 1)</p>
        </div>
    </div>
</body>
</html>`;
