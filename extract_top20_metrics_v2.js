...
console.log('\n📊 Extracting Top 20 Good Performers with Current GP% (Most Recent Valid Data)\n');
...
console.log('=====================\n');
console.log('Rank | Code | Product Name | Qty/Mo | GP%/Mo | Current GP%');
console.log('-----|------|--------------|--------|--------|------------');

top20.forEach((p, i) => {
  const desc = p.description.substring(0, 30).padEnd(30);
...
const jsonOutput = {
  top20: top20.map((p, i) => ({
    ...
    gpPercentGrowthPerMonth: parseFloat(p.gpSlope.toFixed(2)),
