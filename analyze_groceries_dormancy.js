...
console.log('\n📊 SPAR Sigma - Groceries Department - Dormancy Analysis (Scenario 3)\n');

const inputFile = 'Spar/Data Extracts/gws groceries.xls';
const outputJsonFile = 'Spar/Data Extracts/groceries_product_status.json';
const outputHtmlFile = 'Spar/Data Extracts/groceries_product_status_report.html';

console.log(`Input File: ${inputFile}`);
console.log(`Reference Date: 19 April 2026`);
console.log(`Analysis Period: 1 March 2022 - 1 April 2026 (50 months)\n`);
...
<head>
    ...
    <title>SPAR Groceries - Product Status Report</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 Groceries Department - Product Status Analysis</h1>
        ...
        <div class="footer">
            <p>Report Generated: 19 April 2026 | SPAR Groceries Department | Product Status Analysis (Scenario 3)</p>
        </div>
    </div>
</body>
</html>`;
