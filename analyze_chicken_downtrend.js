...
console.log('\n📊 SPAR Sigma - Chicken Department - Bad Performers Analysis (Scenario 2)\n');

const inputFile = 'Spar/Data Extracts/gws chicken.xls';
const outputJsonFile = 'Spar/Data Extracts/chicken_cull_candidates.json';
const outputHtmlFile = 'Spar/Data Extracts/chicken_cull_candidates_report.html';
...
let tier2Html = tier2.slice(0, 10).map(p =>
...
let tier3Html = tier3.slice(0, 10).map(p =>
...
const tier2More = tier2.length > 10 ? '<p style="text-align: center; color: #999; margin-top: 10px;">... and ' + (tier2.length - 10) + ' more in Tier 2</p>' : '';
const tier3More = tier3.length > 10 ? '<p style="text-align: center; color: #999; margin-top: 10px;">... and ' + (tier3.length - 10) + ' more in Tier 3</p>' : '';
...
<head>
    ...
    <title>SPAR Chicken - Cull Candidates Analysis</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>🗑️ Chicken Department - Bad Performers (Cull Candidates)</h1>
        ...
        <div class="section">
            ...
            <div class="alert">
                <strong>⚠️ Finding:</strong> ${badProducts.length} chicken products show declining trends in sales volume and/or profitability. These are candidates for culling, consolidation, or close monitoring.
            </div>
        </div>
        ...
        <div class="footer">
            <p>Report Generated: 18 April 2026 | SPAR Chicken Department | Bad Performers Analysis (Scenario 2)</p>
        </div>
    </div>
</body>
</html>`;
